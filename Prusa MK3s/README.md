...
```
**current-sense-homing.g - v08/07/20**
```g-code
...
```
**current-sense-normal.g - v08/07/20**
```g-code
...
; Alternative Hotmesh.g - This saved the heightmap as filament type appended to the file name (PETG-heightmap.csv)
