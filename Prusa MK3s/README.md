...
To make filament loading, unloading, and changing the most straightforward and simplistic possible evolution, I have made a set of macro that are readily accessible from the PanelDue.  To take full advantage of the duet filament system you should make system filaments as PLA, PETG, ABS, and PC. This allows you to have custom instructions for each different filament, by adding such to the filament's config.g file. Do note that based on my current macro version, their functionality will fail if you put any code in any of the filaments' load.g and unload.g - please leave those empty.  
